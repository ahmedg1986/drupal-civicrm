...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://agc_user:*75A9xTea@mysql.acquaintsoft.com/drupal_demo?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://agc_user:*75A9xTea@mysql.acquaintsoft.com:3306/civicrm_demo_som?new_link=true');
  }
}
...
$civicrm_root = '/home/agcdev/dev.acquaintsoft.com/drupal-civicrm-test/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/agcdev/dev.acquaintsoft.com/drupal-civicrm-test/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://dev.acquaintsoft.com/drupal-civicrm-test/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '385e89cdd58dc712cd9308f5a33adc62');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/agcdev/dev.acquaintsoft.com/drupal-civicrm-test/sites/default/files/civicrm/templates_c//mail.log');
// }
